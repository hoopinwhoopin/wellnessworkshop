    ...
    <div className='flex bg-white flex-col justify-center items-center p-20 px-[9.5vw]'>
        ...
        <div className='flex flex-col'>
            <div className='mt-20  items-center flex flex-col lg:grid lg:grid-cols-2 gap-y-20 lg:grid-rows-2'>
                ...
                <h4 className='text-[24px]'>“Lorem ipsum dolor sit amet consectetur. Viverra elit <span className='text-[#C94277] tracking-wide font-extrabold'>suspendisse semper lectus </span> amet velit. Aliquet duis orci in convallis.”</h4>
